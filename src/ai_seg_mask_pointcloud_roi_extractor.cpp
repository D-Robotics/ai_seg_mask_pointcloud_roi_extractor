...
namespace robot::ai_seg_mask_pointcloud_roi_extractor
{
    ...
    bool MaskPcRoiExtractor::checkSingleTopic(const std::string &topic_name)
    {
        if (topic_name.empty())
        {
    ...
    bool MaskPcRoiExtractor::checkTopicList(const std::vector<std::string> &topic_list)
    {
        if (topic_list.empty())
        {
    ...
    bool MaskPcRoiExtractor::checkTopicListQuiet(const std::vector<std::string> &topic_list)
    {
