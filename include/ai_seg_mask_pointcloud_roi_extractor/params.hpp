...
{
    /**
     * @brief Shared pointer type for AISegMaskPointCloudROIExtractorPara
     */
    ...
    double      max_depth{5.0};                       /**< Maximum depth value for filtering (meters) */
    ...
    AISegMaskPointCloudROIExtractorPara clone() const { return *this; }

    /** @brief Create a shared_ptr deep copy (shared ownership) */
    Ptr cloneShared() const { return std::make_shared<AISegMaskPointCloudROIExtractorPara>(*this); }
